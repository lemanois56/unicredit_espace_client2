            ...
            <div class="header-content-right">
                ...
                <div class="header-element country-selector">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            <img src="/images/flags/us_flag.jpg" alt="img" class="rounded-circle header-link-icon"><span className="fw-semibold mb-0 lh-1">EN</span>
                        </a>
                ...
                <div class="header-element cart-dropdown">
                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        ...
                        <div v-if="cartList.length" class="p-3 empty-header-item">
                            <div class="d-grid">
                        ...
                        <ul v-if="notificationList.length" class="list-unstyled mb-0" id="header-notification-scroll">
                            <li v-for="(item, key) in notificationList" :key=key class="dropdown-item">
                                <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-semibold"><NuxtLink to="/pages/notifications" v-html="item.title"></NuxtLink></p>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile" style=""> 
                    <li><NuxtLink class="dropdown-item d-flex" to="/pages/profile"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>Profile</NuxtLink></li> 
                    <li><NuxtLink class="dropdown-item d-flex" to="/pages/email/mail-app"><i class="ti ti-inbox fs-18 me-2 op-7"></i>Inbox <span class="badge bg-success-transparent ms-auto">25</span></NuxtLink></li> 
                    <li><NuxtLink class="dropdown-item d-flex border-block-end" to="/pages/to-do-list"><i class="ti ti-clipboard-check fs-18 me-2 op-7"></i>Task Manager</NuxtLink></li> 
